...
namespace AIO.Combat.Druid
{
    ...
    internal class SoloFeral : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell(SpellIds.Druid.Rake), 27f, (s, t) =>!Me.HaveBuff(SpellIds.Druid.Prowl) && Me.ComboPoint <=4 && !t.HaveBuff(SpellIds.Druid.Rake) && (t.HealthPercent >= 35 || t.HealthPercent >= 20 && BossList.MyTargetIsBoss) && !t.IsCreatureType(AIO.Enums.CreatureType.Elemental), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell(SpellIds.Druid.Rip), 28f, (s,t) => Me.ComboPoint >= Settings.Current.SoloFeralFinisherComboPoints && !t.HaveMyBuff(SpellIds.Druid.Rip) && t.HealthPercent >= Settings.Current.SoloFeralRipHealth && !t.IsCreatureType(AIO.Enums.CreatureType.Elemental),  RotationCombatUtil.BotTarget),
