...
namespace AIO.Combat.Paladin
{
    ...
    internal class GroupProtection : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell(SpellIds.Paladin.HolyWrath), 12.5f, (s,t) => EnemiesAttackingGroup.ContainsAtLeast(u => u.IsElite && (u.IsCreatureType(wManager.Wow.Enums.CreatureType.Undead) || u.IsCreatureType(wManager.Wow.Enums.CreatureType.Demon)) && !u.IsStunned && u.CGetDistance() < 10, 2), RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell(SpellIds.Paladin.Exorcism), 13f, (s,t) => (t.IsCreatureType(wManager.Wow.Enums.CreatureType.Undead) || t.IsCreatureType(wManager.Wow.Enums.CreatureType.Demon)) && Me.ManaPercentage > 25 && t.IsElite, RotationCombatUtil.BotTargetFast),
