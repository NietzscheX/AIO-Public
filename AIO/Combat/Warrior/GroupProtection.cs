...
namespace AIO.Combat.Warrior
{
    ...
    internal class GroupProtection : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell(SpellIds.Warrior.Rend), 20f, (s,t) => t.CHealthPercent() >50 && !t.CHaveMyBuff(SpellIds.Warrior.Rend) && !t.IsCreatureType(AIO.Enums.CreatureType.Elemental), RotationCombatUtil.BotTargetFast),
