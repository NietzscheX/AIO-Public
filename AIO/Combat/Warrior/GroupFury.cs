...
namespace AIO.Combat.Warrior
{
    ...
    internal class GroupFury : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell(SpellIds.Warrior.Hamstring), 3f, (s,t) => !t.CHaveBuff(SpellIds.Warrior.Hamstring) && t.CHealthPercent() < 40 && t.IsCreatureType(wManager.Wow.Enums.CreatureType.Humanoid) && !BossList.MyTargetIsBoss && Settings.Current.Hamstring, RotationCombatUtil.BotTargetFast),
            ...
            new RotationStep(new RotationSpell(SpellIds.Warrior.Rend), 11f, (s,t) => (!t.CHaveMyBuff(SpellIds.Warrior.Rend) && !t.IsCreatureType(wManager.Wow.Enums.CreatureType.Elemental) && t.HealthPercent > 75) || (BossList.MyTargetIsBoss && !t.IsCreatureType(wManager.Wow.Enums.CreatureType.Elemental)), RotationCombatUtil.BotTargetFast),
