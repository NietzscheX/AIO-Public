...
namespace AIO.Combat.Warrior
{
    ...
    internal class SoloFury : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep>
        {
            ...
            new RotationStep(new RotationSpell(SpellIds.Warrior.Hamstring), 3f, (s,t) => !t.HaveBuff(SpellIds.Warrior.Hamstring) && t.HealthPercent < 40 && t.IsCreatureType(AIO.Enums.CreatureType.Humanoid) && !BossList.MyTargetIsBoss && Settings.Current.Hamstring, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell(SpellIds.Warrior.Rend), 11f, (s,t) => !t.HaveMyBuff(SpellIds.Warrior.Rend) && !t.IsCreatureType(AIO.Enums.CreatureType.Elemental), RotationCombatUtil.BotTarget),
