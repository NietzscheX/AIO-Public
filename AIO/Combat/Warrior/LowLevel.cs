...
namespace AIO.Combat.Warrior
{
    internal class LowLevel : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell(SpellIds.Warrior.Rend), 4f, (s,t) => !t.HaveMyBuff(SpellIds.Warrior.Rend) && !t.IsCreatureType(AIO.Enums.CreatureType.Elemental), RotationCombatUtil.BotTarget),
